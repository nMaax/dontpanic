...
public class TimestampHandler implements Comparable<TimestampHandler>{
    ...
    */
    ...
    /**
     * Compares this {@link TimestampHandler} with the specified timestamp and returns how many seconds are between them.
     ...
     * @return How many seconds are between them. If the TimestampHandler passed as parameter is after the object where this method is called it will return a negative value, positive otherwise.
     * */
    public double secondDifference(String timestamp, String format) {
    	TimestampHandler other = new TimestampHandler(timestamp, format);
    	return secondDifference(other);
    }
     ...
     *  @return How many seconds are between them. If the TimestampHandler passed as parameter is after the object where this method is called it will return a negative value, positive otherwise.
     *  */
    public double secondDifference(String timestamp) {
